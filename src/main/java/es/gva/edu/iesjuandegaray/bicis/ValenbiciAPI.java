            ...
            if (entity != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < resultsArray.length(); i++) {
                        ...
                        String nombre = estacion.optString("address", "Sin nombre");
                        int bicicletasDisponibles = estacion.optInt("available", 0);
                        int espaciosDisponibles = estacion.optInt("free", 0);
                        System.out.println("\n--------------------------------");
